                        ...
                        <div class="mb-4">
                            <div class="row" data-masonry='{"percentPosition": true }'>
                                ...
                                @if ($latest_school_session_id == $current_school_session_id)
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="p-3 border bg-light shadow-sm">
                                            <h6>Set Total School Days</h6>
                                            <p class="text-primary">
                                                <small><i class="bi bi-info-circle-fill me-2"></i> Define the total number of days the school was open for each semester. This value is used in attendance calculations.</small>
                                            </p>
                                            <a href="{{ route('school.total.school.days.form') }}" class="btn btn-sm btn-outline-primary mt-2"><i class="bi bi-pencil-square"></i> Configure</a>
                                        </div>
                                    </div>
                                    --}}
                                    <div class="col-md-4 mb-4">
