                ...
                <div class="row pt-2">
                    <div class="col ps-4">
                        ...
                        <h3><i class="bi bi-compass"></i>
                            Class #{{$class_name}}
                            @if (optional($academic_setting)->attendance_type == 'course')
                            ...
                            <div class="col-10 bg-white border p-3 shadow-sm">
                                <form action="{{route('attendances.store')}}" method="POST">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @php
                                                $present_students = $existing_attendances->filter(function($attendance) {
                                                    return $attendance->status == 'on';
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input class="form-check-input" type="checkbox"
                                                            name="status[{{$student->student_id}}]" value="on" 
                                                            @if(in_array($student->student_id, $present_students)) checked @endif>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
