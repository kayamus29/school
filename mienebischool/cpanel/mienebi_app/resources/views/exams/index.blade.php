                    ...
                    <div class="col ps-4">
                        <div class="row">
                            ...
                            <div class="col text-end pt-3">
                                {{-- <a href="{{route('exam.create.show')}}" class="btn btn-outline-primary"><i
                                        class="bi bi-plus-lg"></i> Create Exam</a> --}}
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            {{-- <a href="{{route('exam.delete')}}" role="button"
                                                            ...
                                                            <form id="exam-delete-form-{{$exam->id}}"
                                                                action="{{ route('exam.delete') }}" method="POST" class="d-none">
                                                                @csrf
