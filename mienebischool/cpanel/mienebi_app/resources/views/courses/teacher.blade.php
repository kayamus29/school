                                        ...
                                        @isset($courses)
                                            @foreach ($courses as $course)
                                                                                ...
                                                                                <td>
                                                                                    <div class="btn-group">
                                                                                        ...
                                                                                        <ul class="dropdown-menu">
                                                                                            <li><a href="{{route('student.list.show', [
                                                    'class_id' => $course->schoolClass->id,
                                                    'section_id' => $course->section->id,
                                                    'course_id' => $course->course->id
                                                ])}}" role="button" class="dropdown-item fw-bold text-primary"><i
                                                    ...
                                                    'course_name' => $course->course->course_name
                                                                                                        ...
                                                                                                        class="bi bi-calendar2-week me-2"></i> Take
                                                                                                    Attendance</a></li>
                                                    ...
                                                    'course_name' => $course->course->course_name
                                                                                                        ...
                                                                                                        class="bi bi-calendar2-week-fill me-2"></i> View
                                                                                                    Attendance</a></li>
                                                                                            <li><a href="{{route('course.syllabus.index', ['course_id' => $course->course->id])}}"
                                                                                                    role="button" class="dropdown-item"><i
                                                                                                        class="bi bi-journal-text me-2"></i> View Syllabus</a>
                                                                                            </li>
                                                    ...
                                                    'semester_id' => request()->query('semester_id')
                                                                                            ...
                                                                                            <li><a href="{{route('assignment.list.show', ['course_id' => $course->course->id])}}"
                                                                                                    role="button" class="dropdown-item"><i
                                                                                                        class="bi bi-file-post-fill me-2"></i> View
                                                                                                    Assignments</a></li>
                                                    ...
                                                    'semester_id' => $selected_semester_id
                                                                                                        ...
                                                                                                        class="bi bi-input-cursor me-2"></i> Give Marks</a></li>
                                                    ...
                                                    'semester_id' => $selected_semester_id
                                                                                                        ...
                                                                                                        class="bi bi-cloud-sun me-2"></i> View Final Results</a>
                                                                                            </li>
                                                                                            <li><a href="#" role="button" class="dropdown-item disabled"
                                                                                                    tabindex="-1" aria-disabled="true"><i
                                                                                                        class="bi bi-chat-left-text me-2"></i> Message
                                                                                                    Students</a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </td>
