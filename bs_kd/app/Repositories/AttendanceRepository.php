...
class AttendanceRepository implements AttendanceInterface {
    ...
    public function deleteTodayAttendance($class_id, $section_id, $course_id, $session_id, $attendance_type) {
        try {
            ...
            throw new \Exception('Failed to delete today\'s attendance. '.$e->getMessage());
        }
    }

    public function getTodayAttendance($class_id, $section_id, $course_id, $session_id, $attendance_type) {
        try {
            $query = Attendance::where('class_id', $class_id)
                               ->where('session_id', $session_id)
                               ->whereDate('created_at', '=', Carbon::today());
            ...
            throw new \Exception('Failed to get today\'s attendance. '.$e->getMessage());
        }
    }
}