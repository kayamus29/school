            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-gray-900 dark:text-white"
                        style="border: 1px solid #1a202c;padding: 5px;border-radius: 5px;">Login</a>
            ...
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                <h1 class="text-gray-900 dark:text-white">
                    @if(isset($site_setting) && $site_setting->school_logo_path)
                        <img src="{{ asset($site_setting->school_logo_path) }}" class="mr-2" height="50px" width="50px">
                    @else
                        <img src="{{asset('favicon_io/android-chrome-512x512.png')}}" class="mr-2" height="50px"
                            width="50px">
                    @endif
                    <span
                        style="font-size: 45px; color: {{ $site_setting->primary_color ?? '#8a6dd9' }};">{{ $site_setting->school_name ?? 'nifiedtransform' }}</span>
                </h1>
