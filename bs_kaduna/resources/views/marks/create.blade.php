                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                {{-- Show all students from sectionStudents, including those without marks
                                                --}}
                                                @foreach ($sectionStudents as $sectionStudent)
                                                    @php
                                                        ...
                                                        $hasMarks = isset($students_with_marks[$studentId]);
                                                    @endphp

                                                    {{-- Skip if already shown in the students_with_marks loop above --}}
                                                    @if(!$hasMarks)
                                                        <tr>
                                                            <td>{{$student->first_name}} {{$student->last_name}}</td>
                                                            @isset($exams)
