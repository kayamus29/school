                                            ...
                                            <tbody>
                                                @isset($students_with_marks)
                                                    @foreach ($students_with_marks as $id => $students_with_mark)
                                                        <tr>
                                                            <td>{{$students_with_mark[0]->student->first_name}}
                                                                {{$students_with_mark[0]->student->last_name}}</td>
                                                            @php
                                                                $calculated_marks = 0;
                                                            @endphp
                                                            ...
                                                            <td><input type="number" step="0.01" class="form-control"
                                                                    ...
                                                                    value="{{$calculated_marks}}" readonly></td>
                                                            <td><input type="number" step="0.01" class="form-control"
                                                                    name="final_mark[{{$students_with_mark[0]->student->id}}]"
                                                                    required></td>
                                                            <td><textarea type="text" class="form-control" rows="1"
                                                                    name="note[{{$students_with_mark[0]->student->id}}]"
                                                                    placeholder="Counted best 2 Quizes from 3,..."></textarea></td>
                                                        </tr>
                                                    @endforeach
                                                @endisset
